...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    ...
    <div class="d-flex gap-2 flex-wrap">
        ...
        <form method="POST" action="<?= htmlspecialchars(
            ...
            <button type="submit" class="btn btn-outline-secondary" title="Verificar recorrências vencidas">
        ...
        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
            data-bs-target="#novaRecorrenciaModal">
            + Recorrência
        </button>


        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
            data-bs-target="#novoParcelamentoModal">
            + Parcelamento
        </button>
...
<?php if (
    isset($_GET['recorrencias_processadas'])
    &&
    $_GET['recorrencias_processadas'] === '1'
): ?>

    <?php

    $recorrenciasVerificadas =
        isset($_GET['recorrencias_verificadas'])
        ? (int) $_GET['recorrencias_verificadas']
        : 0;

    $ocorrenciasCriadas =
        isset($_GET['ocorrencias_criadas'])
        ? (int) $_GET['ocorrencias_criadas']
        : 0;

    $recorrenciasEncerradas =
        isset($_GET['recorrencias_encerradas'])
        ? (int) $_GET['recorrencias_encerradas']
        : 0;
    ...
    <div class="alert alert-success">
        ...
        Recorrências atualizadas.

        <strong>
            <?= $ocorrenciasCriadas ?>
        </strong>

        <?= $ocorrenciasCriadas === 1
            ? 'movimentação criada.'
            : 'movimentações criadas.'
            ?>

        <?php if (
            $recorrenciasEncerradas > 0
        ): ?>

            <?= $recorrenciasEncerradas ?>

            <?= $recorrenciasEncerradas === 1
                    ...
                    <div class="uai-transaction-main">
                        ...
                        <div class="uai-transaction-meta">
                            ...
                            <?php if (
                                ...
                                <span class="uai-installment-badge">
...
<div class="modal fade" id="novoParcelamentoModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div>
                    ...
                    <div class="text-uai-muted small">
                        O UaiMoney criará uma movimentação
                        pendente para cada parcela.
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <label class="form-label" for="parcelamentoDescricao">
                                Descrição
                            </label>

                            <input type="text" class="form-control" id="parcelamentoDescricao" name="descricao"
                        ...
                        <div class="col-md-4">
                            ...
                            <label class="form-label" for="parcelamentoValor">
                                Valor total
                            </label>

                            <input type="number" class="form-control" id="parcelamentoValor" name="valor_total"
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="form-label" for="parcelamentoCategoria">
                                Categoria
                            </label>

                            <select class="form-select" id="parcelamentoCategoria" name="subgrupo_id" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="form-label" for="parcelamentoConta">
                                Conta
                            </label>

                            <select class="form-select" id="parcelamentoConta" name="conta_id">
                        ...
                        <div class="col-md-4">
                            ...
                            <label class="form-label" for="parcelamentoParcelas">
                                Parcelas
                            </label>

                            <input type="number" class="form-control" id="parcelamentoParcelas" name="total_parcelas"
                                min="2" max="120" value="2" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <label class="form-label" for="parcelamentoPrimeiroVencimento">
                                Primeiro vencimento
                            </label>

                            <input type="date" class="form-control" id="parcelamentoPrimeiroVencimento"
                                name="primeiro_vencimento" value="<?= date('Y-m-d') ?>" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <label class="form-label" for="parcelamentoMeio">
                                Meio de pagamento
                            </label>

                            <select class="form-select" id="parcelamentoMeio" name="meio_pagamento">
                        ...
                        <div class="col-12">
                            ...
                            <label class="form-label" for="parcelamentoObservacao">
                                Observação
                            </label>

                            <textarea class="form-control" id="parcelamentoObservacao" name="observacao" rows="2"
...
<div class="modal fade" id="novaRecorrenciaModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div>
                    ...
                    <div class="text-uai-muted small">
                        A movimentação será criada somente
                        quando chegar a data programada.
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control" name="descricao" placeholder="Ex.: Plano de celular"
                                required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" name="valor" min="0.01" step="0.01" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="subgrupo_id" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" name="intervalo" value="1" min="1" max="120"
                                required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="recorrenciaDuracao" name="tipo_duracao">

                                <option value="indefinida">
                                    Sem término
                                </option>
                        ...
                        <div class="col-md-6 d-none" id="recorrenciaQuantidadeContainer">

                            <label class="form-label">
                                Ocorrências
                            </label>

                            <input type="number" class="form-control" id="recorrenciaQuantidade"
                                name="total_ocorrencias" min="1" max="1200" placeholder="Ex.: 12">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="meio_pagamento">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        */
        ...
        const recorrenciaDuracao =
            document.getElementById(
                'recorrenciaDuracao'
            );

        const recorrenciaQuantidadeContainer =
            document.getElementById(
                'recorrenciaQuantidadeContainer'
            );

        const recorrenciaQuantidade =
            document.getElementById(
                'recorrenciaQuantidade'
            );


        recorrenciaDuracao?.addEventListener(
            'change',
            function () {
                ...
                if (recorrenciaQuantidade) {
                    ...
                    recorrenciaQuantidade.required =
                        definida;


                    if (!definida) {
                        recorrenciaQuantidade.value = '';
                    }
                }
            }
        );
