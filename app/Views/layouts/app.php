...
$navigation=['/'=>'Visão geral','/movimentacoes'=>'Movimentações','/contas'=>'Contas','/cartoes'=>'Cartões','/recorrencias'=>'Recorrências','/planejamento'=>'Planejamento','/analises'=>'Análises','/carteira'=>'Conferir e transferir','/categorias'=>'Categorias'];
...
<div class="d-flex align-items-center gap-2"><a class="btn btn-uai-primary btn-sm" href="<?= H::escape($basePath.'/movimentacoes#novo') ?>">+ Novo lançamento</a><button type="button" class="btn btn-outline-secondary btn-sm" id="themeToggle" aria-label="Alternar tema claro e escuro">Alternar tema</button>
